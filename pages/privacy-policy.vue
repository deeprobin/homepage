<template>
  <div class="privacy-policy">
    <div class="container">
      ...
      <p>Die aufgezeichneten Daten werden zusammen mit der zufallsgenerierten User-ID gespeichert, was die Auswertung pseudonymer Nutzerprofile ermöglicht.</p>
      <p>Sollten Sie mit der Erfassung nicht einverstanden sein, können Sie <a @click="disable()">hier</a> Google Analytics deaktivieren.</p>
    ...
    meta: [
      {
        hid: 'title',
        property: "title",
        content: "DeepRobin.DE: Datenschutzerklärung"
      },
      {
        hid: 'description',
        property: "description",
        content: "Auf dieser Seite befinden sich alle Informationen, welche dem Schutze Ihrer Daten dienen."
      },
      {
        hid: 'robots',
        name: 'robots',
